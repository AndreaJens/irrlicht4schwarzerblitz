...
#ifdef _IRR_COMPILE_WITH_XFK_LOADER_

#include "CFKMeshFileLoader.h"
...
namespace irr
{
	namespace scene
	{
		...
		//! Constructor
		CFKMeshFileLoader::CFKMeshFileLoader(scene::ISceneManager* smgr, io::IFileSystem* fs)
		...
		{
#ifdef _DEBUG
			setDebugName("CFKMeshFileLoader");
#endif
			TextureLoader = NULL;
		...
		bool CFKMeshFileLoader::isALoadableFileExtension(const io::path& filename) const
		{
			return core::hasFileExtension(filename, "fkx");
		}
		...
		IAnimatedMesh* CFKMeshFileLoader::createMesh(io::IReadFile* file)
		{
			if (!file)
				return 0;
		...
		bool CFKMeshFileLoader::load(io::IReadFile* file)
		{
		...
		bool CFKMeshFileLoader::readFileIntoMemory(io::IReadFile* file)
		{
		...
		//! Parses the file
		bool CFKMeshFileLoader::parseFile()
		{
		...
		bool CFKMeshFileLoader::parseDataObject()
		{
		...
		bool CFKMeshFileLoader::parseDataObjectTemplate()
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectFrame(CSkinnedMesh::SJoint *Parent)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectTransformationMatrix(core::matrix4 &mat)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectMesh(SXMesh &mesh)
		{
			core::stringc name;
		...
		bool CFKMeshFileLoader::parseDataObjectSkinWeights(SXMesh &mesh)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectSkinMeshHeader(SXMesh& mesh)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectMeshNormals(SXMesh &mesh)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectMeshTextureCoords(SXMesh &mesh)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectMeshVertexColors(SXMesh &mesh)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectMeshMaterialList(SXMesh &mesh)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectMaterial(video::SMaterial& material)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectAnimationSet()
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectAnimationTicksPerSecond()
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectAnimation()
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectAnimationKey(ISkinnedMesh::SJoint *joint)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseDataObjectTextureFilename(core::stringc& texturename)
		{
#ifdef _FKREADER_DEBUG
		...
		bool CFKMeshFileLoader::parseUnknownDataObject()
		{
		...
		bool CFKMeshFileLoader::checkForClosingBrace()
		{
			return (getNextToken() == "}");
		}
		...
		bool CFKMeshFileLoader::checkForOneFollowingSemicolons()
		{
			if (BinaryFormat)
				return true;
		...
		bool CFKMeshFileLoader::checkForTwoFollowingSemicolons()
		{
			if (BinaryFormat)
				return true;
		...
		//! if there is one
		bool CFKMeshFileLoader::readHeadOfDataObject(core::stringc* outname)
		{
		...
		core::stringc CFKMeshFileLoader::getNextToken()
		{
			core::stringc s;
		...
		void CFKMeshFileLoader::findNextNoneWhiteSpaceNumber()
		{
			if (BinaryFormat)
				return;
		...
		void CFKMeshFileLoader::findNextNoneWhiteSpace()
		{
			if (BinaryFormat)
				return;
		...
		bool CFKMeshFileLoader::getNextTokenAsString(core::stringc& out)
		{
			if (BinaryFormat)
			{
				out = getNextToken();
		...
		void CFKMeshFileLoader::readUntilEndOfLine()
		{
			if (BinaryFormat)
				return;
		...
		u16 CFKMeshFileLoader::readBinWord()
		{
			if (P >= End)
				return 0;
		...
		u32 CFKMeshFileLoader::readBinDWord()
		{
			if (P >= End)
				return 0;
#ifdef __BIG_ENDIAN__
		...
		f32 CFKMeshFileLoader::readFloat()
		{
			if (BinaryFormat)
			{
				if (!BinaryNumCount)
		...
		bool CFKMeshFileLoader::readVector2(core::vector2df& vec)
		{
			vec.X = readFloat();
			vec.Y = readFloat();
			return true;
		...
		bool CFKMeshFileLoader::readVector3(core::vector3df& vec)
		{
			vec.X = readFloat();
			vec.Y = readFloat();
			vec.Z = readFloat();
		...
		bool CFKMeshFileLoader::readRGB(video::SColor& color)
		{
		...
		bool CFKMeshFileLoader::readRGBA(video::SColor& color)
		{
			video::SColorf tmpColor;
			tmpColor.r = readFloat();
			tmpColor.g = readFloat();
		...
		bool CFKMeshFileLoader::readMatrix(core::matrix4& mat)
		{
			for (u32 i = 0; i<16; ++i)
				mat[i] = readFloat();
			return checkForOneFollowingSemicolons();
