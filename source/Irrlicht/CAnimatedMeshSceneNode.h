...
namespace scene
{
	...
	public:
		...
		virtual void setCurrentFrame(f32 frame, bool resetAnimation = false) _IRR_OVERRIDE_;
		...
		// NEW 23.06.2016//
		virtual bool addAnimation(core::stringw animationName, irr::scene::CAnimationKeyMap* animationKeys);
		virtual bool canPerformAnimation(core::stringw animationName);
		virtual bool setAnimation(core::stringw animationName);
		virtual bool setAnimationFrameLoop(core::stringw animationName, s32 begin, s32 end);
		virtual core::stringw getCurrentAnimationName();
	...
	private:
		...
		f32 FramesPerSecond;
		f32 CurrentFrameNr;
		bool CurrentFrameHasBeenChanged;
		...
		// NEW 23.06.2016//
		std::map<core::stringw, irr::scene::CAnimationKeyMap*> AnimationMap = 
			std::map<core::stringw, irr::scene::CAnimationKeyMap*>();
		core::stringw currentAnimationName = core::stringw();
	};
