...
#ifndef __C_XFK_MESH_FILE_LOADER_H_INCLUDED__
#define __C_XFK_MESH_FILE_LOADER_H_INCLUDED__
...
namespace irr
{
	...
	namespace scene
	{
		...
		class CFKMeshFileLoader : public IMeshLoader
		{
		public:

			//! Constructor
			CFKMeshFileLoader(scene::ISceneManager* smgr, io::IFileSystem* fs);
		...
		private:
			...
			/*
			// NEW 23.06.2016
			bool parseDataObjectAnimationSetOnly(io::IReadFile* file, CAnimationKeyMap* animationKey);
			bool parseDataObjectAnimationSet(CAnimationKeyMap* animationKey);
			*/
